...
Having recently completed my Bachelor's degree at UMSL, I have experience writing and testing code in a number of languages such as Java, Javascript and C/C++. I have worked in a number of programming environments, including Windows, UNIX/Linux and MacOS, and I have used many tools such as those offered by Eclipse, Git, and Violet UML. I enjoyed using and sharpening these skills, as well as working as part of Agile development teams, and believe this opportunity will allow me to continue doing so in a professional capacity.

\lettersection{Why \companyname?}
As a recent computer science graduate with a passion for software development, \companyname, seems like a perfect fit for me. The perfect job for me would be one where I am allowed to tackle a wide variety of complex problems every day, and it is for this reason that market intelligence (Mintel Specifically) interests me greatly . I would love to contribute to the success of this company with my own set of skills!
